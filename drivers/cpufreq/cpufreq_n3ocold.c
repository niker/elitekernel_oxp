...
#define MIN_FREQUENCY_UP_THRESHOLD		(66)
...
#define DEF_CPU_UP_FREQ				(256000)
#define DEF_CPU_DOWN_FREQ			(128000)
...
#define UP_THRESHOLD_AT_MIN_FREQ		(35)
#define FREQ_FOR_RESPONSIVENESS			(340000)
